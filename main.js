...
var Modal = /*#__PURE__*/function () {
  ...
  return _createClass(Modal, null, [{
    ...
    value: function closeModal(modal) {
      if (modal == null) return;
      var errorMsg = document.querySelector('#add-list-error-msg');
...
function list_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function list_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, list_toPropertyKey(o.key), o); } }
function list_createClass(e, r, t) { return r && list_defineProperties(e.prototype, r), t && list_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
...
var List = /*#__PURE__*/function () {
  ...
  return list_createClass(List, [{
    ...
    key: "setTaskPriority",
    value: function setTaskPriority(taskName, priority) {
      return this.getTask(taskName).setPriority(priority);
    }
  }, {
    key: "setTaskDescription",
    value: function setTaskDescription(taskName, description) {
      return this.getTask(taskName).setDescription(description);
    }
  }, {
    key: "setTaskName",
    value: function setTaskName(taskName, newTaskName) {
    ...
    value: function getTodayTasks() {
      return this.tasks.filter(function (task) {
        return isToday(new Date(task.getDueDate()));
      });
    }
  }, {
    key: "getWeekTasks",
    value: function getWeekTasks() {
      ...
      return this.tasks.filter(function (task) {
        return isWithinInterval(new Date(task.getDueDate()), {
          start: weekStart,
          end: weekEnd
        });
      });
...
;// ./src/modules/todo.js
function todo_typeof(o) { "@babel/helpers - typeof"; return todo_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, todo_typeof(o); }
...
function todo_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function todo_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, todo_toPropertyKey(o.key), o); } }
function todo_createClass(e, r, t) { return r && todo_defineProperties(e.prototype, r), t && todo_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function todo_toPropertyKey(t) { var i = todo_toPrimitive(t, "string"); return "symbol" == todo_typeof(i) ? i : i + ""; }
function todo_toPrimitive(t, r) { if ("object" != todo_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != todo_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var Todo = /*#__PURE__*/function () {
  ...
  return todo_createClass(Todo, [{
    ...
    key: "findTask",
    value: function findTask(taskId) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (list.getName() !== 'All Tasks' && list.getName() !== 'Today' && list.getName() !== 'This week') {
            var task = list.getTasks().find(function (task) {
              return task.id === taskId;
            });
            if (task) return task;
          }
    ...
    value: function updateWeekList() {
      var weekList = this.getList('This week');
      weekList.setTasks([]);
      this.lists.forEach(function (list) {
        if (list.getName() !== 'All Tasks' && list.getName() !== 'Today' && list.getName() !== 'This week') {
...
;// ./src/modules/task.js
function task_typeof(o) { "@babel/helpers - typeof"; return task_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, task_typeof(o); }
function task_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function task_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, task_toPropertyKey(o.key), o); } }
function task_createClass(e, r, t) { return r && task_defineProperties(e.prototype, r), t && task_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function task_toPropertyKey(t) { var i = task_toPrimitive(t, "string"); return "symbol" == task_typeof(i) ? i : i + ""; }
function task_toPrimitive(t, r) { if ("object" != task_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != task_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var Task = /*#__PURE__*/function () {
  ...
  return task_createClass(Task, [{
    ...
    key: "setParentList",
    value: function setParentList(parentListName) {
    ...
    value: function setId() {
      this.id = "task-".concat(Date.now(), "-").concat(Math.floor(Math.random() * 1000));
    }
  }, {
    key: "getId",
    ...
    key: "setIsChecked",
    value: function setIsChecked(checkedStatus) {
    ...
    value: function getFormattedDueDate() {
      if (this.dueDate && this.dueDate !== 'No due date') {
        var parsedDate = parseISO(this.dueDate);
...
var Storage = /*#__PURE__*/function () {
  ...
  return storage_createClass(Storage, null, [{
    key: "saveTodoList",
    value: function saveTodoList(data) {
      localStorage.setItem('todoList', JSON.stringify(data));
    }
  }, {
    key: "saveSelectedList",
    value: function saveSelectedList(list) {
      localStorage.setItem('selectedList', JSON.stringify(list));
    }
  }, {
    key: "getSelectedList",
    value: function getSelectedList() {
      var savedList = localStorage.getItem('selectedList');
      if (savedList) {
    ...
    value: function getTodoList() {
      var todoList = Object.assign(new Todo(), JSON.parse(localStorage.getItem('todoList')));
      todoList.setLists(todoList.getLists().map(function (list) {
        return Object.assign(new List(), list);
      }));
      todoList.getLists().forEach(function (list) {
        return list.setTasks(list.getTasks().map(function (task) {
    ...
    key: "addTask",
    value: function addTask(listName, task) {
      var todoList = Storage.getTodoList();
    ...
    key: "deleteTask",
    value: function deleteTask(listName, taskName) {
      var todoList = Storage.getTodoList();
    ...
    key: "updateTaskName",
    value: function updateTaskName(listName, taskName, newTaskName) {
      var todoList = Storage.getTodoList();
    ...
    value: function updateTaskDescription(listName, taskName, description) {
      var todoList = Storage.getTodoList();
    ...
    value: function updateTaskPriority(listName, taskName, priority) {
      var todoList = Storage.getTodoList();
...
;// ./src/modules/ui.js
function ui_typeof(o) { "@babel/helpers - typeof"; return ui_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, ui_typeof(o); }
function ui_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function ui_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, ui_toPropertyKey(o.key), o); } }
function ui_createClass(e, r, t) { return r && ui_defineProperties(e.prototype, r), t && ui_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function ui_toPropertyKey(t) { var i = ui_toPrimitive(t, "string"); return "symbol" == ui_typeof(i) ? i : i + ""; }
function ui_toPrimitive(t, r) { if ("object" != ui_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != ui_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var UI = /*#__PURE__*/function () {
  ...
  return ui_createClass(UI, null, [{
    ...
    value: function loadLists() {
      UI.clearUserLists();
      Storage.getTodoList().getLists().forEach(function (list) {
    ...
    value: function loadTasks() {
      ...
      var tasks = selectedList.getTasks();
    ...
    value: function loadDropdown() {
      ...
      dropdownButtons.forEach(function (dropdown) {
        ...
        dropdownContent.addEventListener('transitionstart', function () {
    ...
    value: function initializeEventListeners() {
      ...
      // Delete list event
      document.querySelector('.user-lists').addEventListener('click', function (event) {
        var deleteButton = event.target.closest('.delete-list');
        if (deleteButton) {
      ...
      document.querySelector('.main-lists-section').addEventListener('click', function (event) {
      ...
      document.querySelector('.list-content').addEventListener('click', function (event) {
        var deleteTaskButton = event.target.closest('.close-task-btn');
        if (deleteTaskButton) {
          UI.handleDeleteTaskEvent(event);
          return;
        }
        var taskCheckBtn = event.target.closest('.task-check-btn');
        if (taskCheckBtn) {
    ...
    key: "handleAddListEvent",
    value: function handleAddListEvent(event) {
      event.preventDefault();
      var modal = document.querySelector('#add-list-modal');
      var inputElement = event.target.elements['new-list-title'];
      var inputValue = inputElement.value.trim();
      var newList = new List(inputValue);
    ...
    key: "handleDeleteListEvent",
    value: function handleDeleteListEvent(event) {
      var list = event.target.closest('.user-list');
      if (list) {
        var todoList = Storage.getTodoList();
        var listTitle = list.querySelector('span').textContent;
    ...
    key: "handleSelectListEvent",
    value: function handleSelectListEvent(event) {
      var list = event.target.closest('.user-list') || event.target.closest('.main-list');
      if (list) {
        var listTitle = list.querySelector('span').textContent;
    ...
    value: function handleAddTaskEvent(event) {
      event.preventDefault();
      var modal = document.querySelector('#add-task-modal');
      var title = event.target.elements['new-task-title'];
      var titleValue = title.value.trim();
      var dueDate = event.target.elements['new-task-due-date'];
      var dueDateValue = dueDate.value;
      var description = event.target.elements['new-task-description'];
      var descriptionValue = description.value;
      var priority = event.target.elements['priority-selector'];
      var priorityValue = priority.value;
      var selectedListName = Storage.getSelectedList();
      var todoList = Storage.getTodoList();
      var newTask = new Task(titleValue, dueDateValue);
    ...
    key: "handleDeleteTaskEvent",
    value: function handleDeleteTaskEvent(event) {
      var todoList = Storage.getTodoList();
      var task = event.target.closest('.list-task');
      var taskId = task.getAttribute('data-task-id');
      var originalTask = todoList.findTask(taskId);
      if (originalTask) {
        var parentList = todoList.getList(originalTask.getParentList());
    ...
    key: "openAddListErrorMsg",
    value: function openAddListErrorMsg() {
      var addListErrorMsg = document.querySelector('#add-list-error-msg');
      addListErrorMsg.textContent = 'The list with this title already exists';
    }
  }, {
    key: "closeAddListErrorMsg",
    value: function closeAddListErrorMsg() {
      var addListErrorMsg = document.querySelector('#add-list-error-msg');
      addListErrorMsg.textContent = '';
    }
  }, {
    key: "toggleDropdown",
    value: function toggleDropdown(dropdownContent) {
    ...
    key: "clearUserLists",
    value: function clearUserLists() {
      var listsContainer = document.querySelector('.user-lists');
      listsContainer.innerHTML = '';
    }
  }, {
    key: "clearListTasks",
    value: function clearListTasks() {
      var tasksContainer = document.querySelector('.list-content');
      tasksContainer.innerHTML = '';
    }
  }, {
    key: "clearListAddTaskButton",
    value: function clearListAddTaskButton() {
    ...
    key: "setSelectedList",
    value: function setSelectedList(listTitle) {
      var selectedList = Storage.getTodoList().getList(listTitle);
      Storage.saveSelectedList(selectedList.name);
      UI.highlightSelectedList();
    }
  }, {
    key: "highlightSelectedList",
    value: function highlightSelectedList() {
      var selectedListName = Storage.getSelectedList();
      if (selectedListName) {
        var allLists = document.querySelectorAll('.user-list, .main-list');
    ...
    key: "updateMainLists",
    value: function updateMainLists() {
      Storage.updateAllTasksList();
      Storage.updateTodayList();
      Storage.updateWeekList();
    }
  }, {
    key: "toggleTaskChecked",
    value: function toggleTaskChecked(event) {
      var todoList = Storage.getTodoList();
      var task = event.target.closest('.list-task');
      var taskId = task.getAttribute('data-task-id');
      var originalTask = todoList.findTask(taskId);
      originalTask === null || originalTask === void 0 || originalTask.setIsChecked(!originalTask.getIsChecked());
    ...
    value: function updateTaskStatus(originalTask) {
      var originalTaskID = originalTask.getId();
      var task = document.querySelector("[data-task-id=\"".concat(originalTaskID, "\"]"));
      var taskLeftPanel = task.querySelector('.task-left-panel');
      var taskRightPanel = task.querySelector('.task-right-panel');
      if (!taskLeftPanel || !taskRightPanel) {
        console.error('Missing task panels');
        return;
      }
      var taskCheckBtn = taskLeftPanel.querySelector('.task-check-btn');
      var icon = taskCheckBtn.querySelector('svg');
      var path = icon.querySelector('path');
      var defaultPath = "M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z";
      var pathWithCheck = "m424-296 282-282-56-56-226 226-114-114-56 56 170 170Zm56 216q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z";
      var taskTitle = taskLeftPanel.querySelector('.task-title');
      var taskDueDate = taskRightPanel.querySelector('.due-date');
      var taskCloseBtn = taskRightPanel.querySelector('.close-task-btn');
      var elementsToUpdate = [task, taskCheckBtn, taskTitle, taskDueDate, taskCloseBtn];
      if (originalTask.getIsChecked() === true) {
        elementsToUpdate.forEach(function (el) {
          return el === null || el === void 0 ? void 0 : el.classList.add('checked');
        });
        path.setAttribute('d', pathWithCheck);
      } else {
        elementsToUpdate.forEach(function (el) {
          return el === null || el === void 0 ? void 0 : el.classList.remove('checked');
        });
        path.setAttribute('d', defaultPath);
      }
    }
  }, {
    key: "initAddTaskButton",
    value: function initAddTaskButton() {
      var tasksContainer = document.querySelector('.list-content');
